...
const TABS = [
  ...
  { id: 'panchanga',     label: 'Pancanga',    short: '\U0001F4C5' },
  { id: 'graha',         label: 'Graha',        short: '\U0001FA90' },
  { id: 'dasha',         label: 'Dasa',         short: '\u23F3' },
  { id: 'yogas',         label: 'Yogas',        short: '\U0001F52E' },
  { id: 'forecast',      label: 'Forecast',     short: '\U0001F324' },
  { id: 'predictions',   label: 'Predictions',  short: '\U0001F31F' },
  { id: 'compatibility', label: 'Match',        short: '\u2764\uFE0F' },
  { id: 'remedies',      label: 'Remedies',     short: '\U0001F48E' },
  { id: 'bot',           label: 'Ask Jyotisa',  short: '\U0001F916' },
];
            ...
            {chartData && (
              <div className="glass-dark p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-mono text-purple-400/70">{chartData.ayanamsa?.toFixed(3)}&deg; Lahiri</span>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-2 gap-2 pt-1">
                  {[
                    ...
                    { label:"Naksatra", value: chartData.panchanga?.nakshatra?.name },
              ...
              <>
                {tab === "chart" && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <BirthChart chartData={chartData} title="Rasi" />
                    <BirthChart chartData={chartData} title="Navamsa" />
                  </div>
                )}
